package com.exemple.ecommerce.ui.gateway.core.property;
...
@Configuration
public class GatewayPropertyConfiguration {

    public static final String JNDI_NAME = "java:comp/env/exemple-ecommerce-gateway-configuration";
